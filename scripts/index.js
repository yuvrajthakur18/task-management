...
/* "...object" is used to spread the data of object where it is being nested  */
/*   E X A M P L E 
...
const data = {
    ...
    3.  console.log({...data})
            O/P: {name: "Yuvraj", age: 25}
                    age: 25
                    name: "Yuvraj"

    4.  console.log({...data, asdaf: "adfgas"})
            O/P: {name: "Yuvraj", age: 25, asdaf: "adfgas"}
            age: 25
            asdaf: "adfgas"
            name: "Yuvraj"
 ...
 /* The above code means : If url is present then set image properties to this */